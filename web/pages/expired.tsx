...
export default function Expired() {
  return (<>
    <Head><title>DauProof — QR expiré</title></Head>
    <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#F0F4F8", padding: 20 }}>
      <div style={{ maxWidth: 420, width: "100%", background: "white", border: "1px solid #E2E8F0", borderRadius: 14, padding: 28, textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: "'DM Serif Display',Georgia,serif", fontSize: 22, marginTop: 8 }}>QR expiré</h1>
        <p style={{ color: "#5A6172", fontSize: 13, marginTop: 8 }}>Rescanne le QR affiché à l'écran du BDE.</p>
